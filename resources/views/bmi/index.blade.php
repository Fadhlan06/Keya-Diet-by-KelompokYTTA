      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-danger">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form method="GET" action="{{ route('bmi.hasil') }}">
              @csrf
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="number" min="0" name="tinggi" class="form-control" id="exampleInputEmail1" placeholder="Masukan Tinggi">
                </div>
                <div class="form-group">
              ...
              <div class="card-footer">
                ...
                {{-- <a href="{{ route('bmi.hasil') }}" class="btn btn-danger">Hitung</a> --}}
              </div>
            </form>
          </div>
          <!-- /.card -->
